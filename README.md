...
├── ./webpack.rules.js
└── ./workspaces
    ├── ./workspaces/angular-xcash-app       # Angular source directory (web renderer part)
    ├── ./workspaces/electron-xcash-app      # Electron source directory (main & preload part)
...
| `npm run start:angular-xcash-app` | Run the app on browser (dev mode)        |
...
- angular-xcash-app
  `npm install --save <dependency> -w angular-xcash-app`
- shared-lib
...
- electron-xcash-app
  `npm run outdated-deps:electron-xcash-app`
- angular-xcash-app
  `npm run outdated-deps:angular-xcash-app`
- shared-lib
...
- electron-xcash-app
  `npm run update-deps:electron-xcash-app`
- angular-xcash-app
  `npm run update-deps:angular-xcash-app`
- shared-lib
...
- ./workspaces/electron-xcash-app/main/assets/icons/icon.png for Linux
- ./workspaces/electron-xcash-app/main/assets/icons/icon.icns for MacOs
- ./workspaces/electron-xcash-app/main/assets/icons/icon.ico for Windows
